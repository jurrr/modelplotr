...
```{r trainmodels, echo=TRUE, eval=FALSE}
...
```{r psn_params, echo=FALSE, eval=FALSE}
# prepare data
text_tbl <- data.frame(
...
```{r prepdata, echo=TRUE, eval=FALSE}
# prepare data
...
```{r plot_cg,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r plot_roi,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r plot_multi,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r plot_cgh,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r plot_crhh,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r customtext,echo=TRUE, eval=FALSE}
...
```{r plotcustomtext,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r plotcustomcolor,echo=TRUE, fig.width=7.2,fig.height=5, eval=FALSE}
...
```{r saveplot,echo=TRUE,eval=FALSE, fig.width=7.2,fig.height=5, eval=FALSE}
