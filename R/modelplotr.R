...
#'
#'#train models using caret... (or use mlr or H2o to train your models... )
...
#'plot_input <- plotting_scope(prepared_input = scores_and_ntiles,scope = 'compare_datasets',select_model_label = 'random forest')
